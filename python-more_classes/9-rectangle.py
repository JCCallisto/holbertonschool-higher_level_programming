...
class Rectangle:
    ...
    def __str__(self):
        ...
        Returns:
            str: A visual representation of the rectangle using the print_symbol
                character. Returns an empty string if width or height is 0.
    ...
    def square(cls, size=0):
        ...
        Returns:
            Rectangle: A new Rectangle instance with width and height both set to size.

        Raises:
            TypeError: If size is not an integer (raised by Rectangle.__init__).
